...
After completing verification, self-check for quality tracking:

- [ ] Pass 1 (deterministic) was completed before Pass 2 and Pass 3 — do not skip ahead
- [ ] Every blocking issue has a specific, actionable description (not "needs improvement")
- [ ] All four perspectives in Pass 3 cover distinct concerns (no overlapping findings)
- [ ] Style-only issues are advisory, not blocking (VERIFY with advisory, not REJECT)
